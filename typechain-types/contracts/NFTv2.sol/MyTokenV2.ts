...
export interface MyTokenV2Interface extends utils.Interface {
  functions: {
...
export interface MyTokenV2 extends BaseContract {
  ...
  functions: {
    ...
    demo(overrides?: CallOverrides): Promise<[boolean]>;
